...
<table <?php $this->classes('nopmb cp_ctable'); ?>>
  ...
  <tr>
    <td <?php $this->classes('cp_section_head'); ?>>Course Information <small>(<a href="<?php echo site_url(); ?>/category/course-information">Visit on site</a>)</small></td>
  </tr>
  <?php $info = false; ?>
  <tr>
  ...
  <tr>
    <td <?php $this->classes('nopmb cp_section_head'); ?>>Forum Activity <small>(<a href="<?php echo site_url(); ?>/forums">Visit on site</a>)</small></td>
  </tr>
  <tr>
      ...
      <table <?php $this->classes('nopmb cp_twotable'); ?>>
        <tr>
          <td <?php $this->classes('nopmb cp_onetd'); ?>><div <?php $this->classes('cp_onecell'); ?>>
              <h2 <?php $this->classes('cp_ch2'); ?>>Recent Topics (last 5)</h2>
              <? if(function_exists('get_bbp_recent_topics'))
					get_bbp_recent_topics();
			?>
            </div></td>
          <td <?php $this->classes('nopmb cp_onetd'); ?>><div <?php $this->classes('cp_onecell'); ?>>
              <h2 <?php $this->classes('cp_ch2'); ?>>Recent Replies (last 5)</h2>
