		...
		<div id="header">
			...
			?>
            	<?php wp_nav_menu( array( 
									...
									'items_wrap' => '<div class="mobile-menu"><form><select onchange="if (this.value) window.location.href=this.value"><option>--Menu--</option>%3$s'.$profilelink.'</select></form></div>' )); ?>
            </div>
