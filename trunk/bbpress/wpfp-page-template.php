<?php
    ...
    if ($favorite_post_ids):
        ...
        while ( have_posts() ) : the_post();
			...
			if (wpfp_check_favorited(get_the_ID())):
        		echo wpfp_link_html(get_the_ID(), wpfp_get_option('remove_favorite'), "remove");
    		else:
        		echo wpfp_link_html(get_the_ID(), wpfp_get_option('add_favorite'), "add");
			endif;
