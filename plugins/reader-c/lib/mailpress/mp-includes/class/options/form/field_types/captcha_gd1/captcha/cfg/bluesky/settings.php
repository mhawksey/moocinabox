...
$charclear = 80;   // Intensité de la transparence des caractères (0->127)
...
$charel = 'ABCDEFGHKLMNPRTWXYZ3569';       // Caractères autorisés

$crypteasy = false;       // Création de cryptogrammes "faciles à lire" (true/false)
                         // composés alternativement de consonnes et de voyelles.

$charelc = 'BCDFGHKLMNPRTWXZ';   // Consonnes utilisées si $crypteasy = true
$charelv = 'AY';                 // Voyelles utilisées si $crypteasy = true
