...
$cryptheight = 45;   // Hauteur du cryptogramme (en pixels)
...
$bgimg = 'fonds';                 // Le fond du cryptogramme peut-être une image  
...
$charclear = 20;   // Intensité de la transparence des caractères (0->127)
...
//$tfont[] = 'ADVERTMF.TTF';       // Vous devez copier les fichiers correspondants
...
$charspace = 26;        // Espace entre les caracteres (en pixels)
$charsizemin = 26;      // Taille minimum des caractères
$charsizemax = 26;      // Taille maximum des caractères
