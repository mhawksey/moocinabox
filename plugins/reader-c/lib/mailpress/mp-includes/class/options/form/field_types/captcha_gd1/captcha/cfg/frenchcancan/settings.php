...
$cryptheight = 55;   // Hauteur du cryptogramme (en pixels)
...
$charspace = 30;        // Espace entre les caracteres (en pixels)
$charsizemin = 26;      // Taille minimum des caractères
$charsizemax = 26;      // Taille maximum des caractères

$charanglemax  = 15;     // Angle maximum de rotation des caracteres (0-360)
