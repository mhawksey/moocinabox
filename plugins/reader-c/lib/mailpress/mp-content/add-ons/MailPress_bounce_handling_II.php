...
// for batch mode
		add_action('mp_process_bounce_handling_II', 	array(__CLASS__, 'process'));
...
// schedule
	public static function schedule()
	{
		...
		if (!wp_next_scheduled( 'mp_process_bounce_handling_II' )) 
			wp_schedule_single_event($now4cron + $config['every'], 'mp_process_bounce_handling_II');
	}
...
// install
	...
	{
		wp_clear_scheduled_hook('mp_process_bounce_handling_II');
	}
...
// for settings
	...
	{
		include (MP_ABSPATH . 'mp-admin/includes/settings/batches_bounce_handling_II.form.php');
	}
